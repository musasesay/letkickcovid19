...
class AboutActivity : AppCompatActivity(),ConnectivityReceiverListener,
NavigationView.OnNavigationItemSelectedListener,AdvancedWebView.Listener {
    ...
    private val navigasjonen = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        when (item.itemId) {
            ...
            R.id.nav_donate -> {
                val intent = Intent(this@AboutActivity, DonateActivity::class.java)
                startActivity(intent)
                return@OnNavigationItemSelectedListener true
            }
            R.id.nav_about -> {
            ...
            R.id.nav_becomeamember -> {
                val intent = Intent(this@AboutActivity, RegisterActivity::class.java)
                startActivity(intent)
                return@OnNavigationItemSelectedListener true
            }
            R.id.navigation_home -> {
...
//        }
    ...
    private fun setWebView(){
        ...
        if(isConnected()) {
            showProgress(true)
            mWebView.loadUrl(Config.ABOUT_URL)
        }else{
