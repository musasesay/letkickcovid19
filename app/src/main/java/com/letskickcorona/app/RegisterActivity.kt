...
class RegisterActivity : AppCompatActivity(),ConnectivityReceiverListener,
NavigationView.OnNavigationItemSelectedListener,AdvancedWebView.Listener {
    ...
    private val navigasjonen = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        when (item.itemId) {
            ...
            R.id.nav_donate -> {
                val intent = Intent(this@RegisterActivity, DonateActivity::class.java)
                startActivity(intent)
                return@OnNavigationItemSelectedListener true
            }
            R.id.nav_about -> {
                val intent = Intent(this@RegisterActivity, AboutActivity::class.java)
                startActivity(intent)
                return@OnNavigationItemSelectedListener true
            }
     ...
     //   val bottomNavView: BottomNavigationView = findViewById(R.id.navigation)
       // bottomNavView.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener)
        ...
        if(Config.SIDEBAR_ENABLED) {
            ...
            //val navView: NavigationView = findViewById<NavigationView>(R.id.navigation)
...
//                setOf(
//                    R.id.nav_donate, R.id.nav_becomeamember, R.id.navigation_home
//                )
         //   )
            ...
            setContentView(R.layout.activity_becomemeber)
            val toolbar = findViewById<Toolbar>(R.id.toolbar)
            setSupportActionBar(toolbar)
            val bottomNavigation = findViewById<BottomNavigationView>(R.id.navigationView)
            //bottomNavigation.setSelectedItemId(R.id.home)
...
//        }
    ...
    private fun setWebView(){
        ...
        if(isConnected()) {
            showProgress(true)
            mWebView.loadUrl(Config.BECOMEMEMBER_URL)
        }else{
