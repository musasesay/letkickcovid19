...
class DonateActivity : AppCompatActivity(),ConnectivityReceiverListener,
...
//    }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.nav_donate->{
                val intent = Intent(this@DonateActivity, DonateActivity::class.java)
                this.startActivity(intent)
            }
            R.id.nav_about->{
                val intent = Intent(this@DonateActivity, AboutActivity::class.java)
                this.startActivity(intent)
            }
            R.id.nav_becomeamember->{
                val intent = Intent(this@DonateActivity, RegisterActivity::class.java)
                this.startActivity(intent)
            }
        }
        val drawer = findViewById<DrawerLayout>(R.id.drawer_layout)
